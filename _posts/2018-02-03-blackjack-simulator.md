...
A major project for Michigan computer science students to program is Euchre, a card game similar to Bridge. It was annoying for out of state students (if they hadn't already been taught the game by friends), because the rules are tricky to program even if you already know them. 
