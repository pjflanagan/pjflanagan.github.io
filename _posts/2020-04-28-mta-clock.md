...
I found a cheap circuit board online called the [Wemos D1 R2 with ESP8266 WiFi](https://amzn.to/4vIaW8t). I found it exceedingly difficult to work with in my IDE and would not recommend doing the same. Next time I have a project like this, I will use a regular Arduino Wifi. I also regret using 12V stepper motors, as they require power outside of the Arduino board, which felt like a fire hazard. I instead would maybe try and figure out a way to do this with [low power servo motors](https://amzn.to/3QHdmUN), or would just ditch motors in favor of lights instead. 
