...
I found a cheap circuit board online called the `Wemos D1 R2 with ESP8266 WiFi`. <!-- AMAZON: Microcontrollers: Arduino Nano, ESP8266 (Wemos D1 Mini) --> <!-- AMAZON: Jump Wires & Breadboards: Essential for prototyping --> I found it exceedingly difficult to work with in my IDE and would not recommend doing the same. Next time I have a project like this, I will use a regular Arduino Wifi. I also regret using 12V stepper motors, as they require power outside of the Arduino board, which felt like a fire hazard. I instead would maybe try and figure out a way to do this with low power servo motors, or would just ditch motors in favor of lights instead. <!-- AMAZON: Servo Motors: SG90 Micro Servos (the "better" alternative for the clock) --> <!-- AMAZON: Soldering Stations: Hakko FX-888D or entry-level kits -->
## Construction
...
![Board holding a board and a single motor](/assets/posts/2020/mta-clock/1-board1.jpeg)

![Board expanded to a board and two motors](/assets/posts/2020/mta-clock/1-board2.jpeg)
...
![Painting the G train logo on a box](/assets/posts/2020/mta-clock/2-paint1.jpeg)
...
![Decoration attaching a subway map](/assets/posts/2020/mta-clock/2-decoration1.jpeg)

### Assembly

I fit the circuit board into the box using extra cardboard and glue. Notice the way the box is cut on the bottom flap to allow it to close properly.

![Inserting the board into the box](/assets/posts/2020/mta-clock/3-assembly2.jpeg)

I added straws to allow the string to slide up and down more easily.

![Another angle of the assembly, with straws inserted](/assets/posts/2020/mta-clock/3-assembly3.jpeg)
...
![Final closed up box with logo](/assets/posts/2020/mta-clock/4-final.jpeg)

And would look like this if wall mounted with backing and toy subway cars.

![Mockup of what it would ideally look like on a wall](https://raw.githubusercontent.com/pjflanagan/MTA-G-Train-Clock/master/read_me/concept.jpg)
