...
categories: web game
image: /assets/posts/2025/yes-chef/yes-chef.webp
github: 
website: https://yes-chef.flanny.app/
---
...
Reusing some code from [an old game](/blog/2021/nuclear-codes/), I came up with a scrolling-text choose-your-own-adventure story.
...
![Intro to Yes, Chef!](/assets/posts/2025/yes-chef/intro.png)

Eventually they meet characters and get to make dialog choices.

![A choice being selected](/assets/posts/2025/yes-chef/choice.png)
...
![Dice rolling across the screen](/assets/posts/2025/yes-chef/roll.png)
...
![Roll results in editor](/assets/posts/2025/yes-chef/editor.png)
...
When I first programmed this editor, the nodes were stored in FaunaDB, a simple object store perfect for this use case. I'm quite fond of FQL, the query language they used to retrieve data. It looked more like SQL than the mess of JSON MongoDB uses to query.

While I was working on Yes, Chef!, FaunaDB went out of business. They gave all their customers about a month's warning that their data would be lost if they do not migrate. This is a ridiculously short amount of time. 

To get around it, I exported all the example games I had been working on and started to rebuild in MongoDB.
