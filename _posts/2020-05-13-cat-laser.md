...
date: 2020-05-13
title: Cat Laser
description: An Arduino laser pointer cat toy
categories: 
...
In spring of 2019 I moved in to a new apartment with a woman who owned a cat. Charlotte was a pudgy, sociable, and feisty grey cat who would hit you if she wanted your attention. During the pandemic, I made time to make her a toy. <!-- AMAZON: Interactive Cat Toys: Automatic laser towers (for those who don't want to build one) --> Using a tutorial I saw online and a small Arduino, I made her a laser pointer turret.
...
![Cat Laser circuit schema](/assets/posts/2020/cat-laser/schema.png)
...
I purchased a kit for building turrets like this one that houses two servo motors. <!-- AMAZON: Laser Diodes: 5V laser modules for Arduino --> <!-- AMAZON: Pan-Tilt Kits: Dual-axis servo mounts --> The final build was screwed and stickered into a scrap piece of wood and plugged into an outlet or portable charger. 

![Final build, "mounted" on the edge of a table](/assets/posts/2020/cat-laser/laser.jpg)
